...
//public class PersonalTaskTable extends AbstractTableModel{
...
//
//	     public PersonalTaskTable(String[] columnNames) {
...
//	         PersonalTask record = (PersonalTask)dataVector.get(row);
//	         switch (column) {
//	             case TITLE_INDEX:
